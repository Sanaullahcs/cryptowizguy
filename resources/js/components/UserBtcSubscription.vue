            ...
            <div class="card-body">
              ...
              <div class="row pt-3 pb-2">
                ...
                <div class="col-md-6 text-right">
                  <h4>
                    ...
                    {{ (this.subscriptions.stripe_price / 100).toFixed(2) }}
                  </h4>
                </div>
              </div>
              <p class="card-text">
              ...
              <div class="row">
                <div class="col-md-6">
                  <p>Start Date:</p>
                  <p>
                    {{ formatDate(subscriptions.trial_ends_at) }}
                  </p>
                </div>
                <div class="col-md-6 text-right">
                  <p>End Date:</p>
        ...
        <div class="col-md-6">
          <div class="card">
            <div class="card-body">
              ...
              <a class="btn bt-sm btn-primary mt-5" @click="cancelSubscription"
                ...
                <div class="row">
                  ...
                  <div class="col-md-12 col-xs-12 text-left" style="padding-top: 20px">
                    ...
                    <div class="text-right">
                      ...
                      <p><b>Transaction number</b>:{{ subscriptions.invoice_number }}</p>
                    </div>
                    <!-- <div style="padding-bottom: 6px">
                ...
                <div class="column-table">
                  ...
                  <table id="recipt" class="mt-3">
                    ...
                    <tbody>
                      <tr>
                        <td>
                          {{ formatDate(subscriptions.created_at) }}
                          -
                          {{ formatDate(subscriptions.ends_at) }}
                        </td>
                        <td></td>
                      ...
                      <tr
                        v-if="
                          subscriptions.couponcode == '' && subscriptions.registerdiscount
                        "
                      >
                        <td>Less discount</td>
                        <td>({{ subscriptiondiscount }}) % off</td>
                        <td>
                          {{
                            (
                      ...
                      >
                        ...
                        <td>
                          ...
                          {{
                            (
                              this.usersubscription.price -
                              (usersubscription.price / 100) * subscriptiondiscount
                            ).toFixed(2)
                          }}
                        </td>
                      </tr>
                      ...
                      >
                        ...
                        <td>
                          ...
                          {{
                            (
                              this.usersubscription.price -
                              (this.usersubscription.price / 100) *
